...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="input label list__input";
...
var editTask=function(){
    ...
    if(containsClass){
        ...
        label.classList.remove('list__label_hide')
        editInput.classList.remove('list__input_active')
    }else{
        editInput.value=label.innerText;
        editBtn.innerText = "Save";
        label.classList.add('list__label_hide')
        editInput.classList.add('list__input_active')
    }
